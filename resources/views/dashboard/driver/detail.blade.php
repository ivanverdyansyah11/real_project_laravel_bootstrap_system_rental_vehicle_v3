                            ...
                            <div class="col-md-6">
                                <div class="input-group d-flex flex-column">
                                    ...
                                    <input type="text" class="input w-100" name="fullname" id="fullname"
                                        autocomplete="off" readonly value="{{ $user->driver->fullname }}">
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="input-group d-flex flex-column">
                            ...
                            <div class="col-md-6">
                                <div class="input-group d-flex flex-column">
                                    ...
                                    <input type="text" class="input w-100" name="phone_number" id="phone_number"
                                        autocomplete="off" readonly value="{{ $user->driver->phone_number }}">
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="input-group d-flex flex-column">
                                    ...
                                    <input type="text" class="input w-100" name="nik" id="nik"
                                        autocomplete="off" readonly value="{{ $user->driver->nik }}">
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="input-group d-flex flex-column">
                                    <label for="identity_card_number">Identity Card Number</label>
                                    <input type="text" class="input w-100" name="identity_card_number"
                                        id="identity_card_number" autocomplete="off" readonly
                                        value="{{ $user->driver->identity_card_number }}">
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="input-group d-flex flex-column">
                                    <label for="drivers_license_number">Drivers License Number</label>
                                    <input type="text" class="input w-100" name="drivers_license_number"
                                        id="drivers_license_number" autocomplete="off" readonly
                                        value="{{ $user->driver->drivers_license_number }}">
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="input-group d-flex flex-column">
                                    <label for="status">Status</label>
                                    <input type="text" class="input w-100" name="status" id="status"
                                        autocomplete="off" readonly
                                        value="{{ $user->driver->status == 1 ? 'Active' : 'Unactive' }}">
                                </div>
                            </div>
                            <div class="col-12">
                                <div class="input-group d-flex flex-column">
                                    <label for="address">Address</label>
                                    <textarea class="input w-100" name="address" id="address" autocomplete="off" rows="4" readonly>{{ $user->driver->address }}</textarea>
                                </div>
                            </div>
                            <div class="col-12">
                                <div class="button-group d-flex gap-2">
                                    <a href="{{ route('driver.index') }}" class="button-reverse">Back to Driver Page</a>
                                </div>
                            </div>
                        </div>
                    </form>
