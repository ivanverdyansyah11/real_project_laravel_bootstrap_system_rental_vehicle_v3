        ...
        <div class="row">
            ...
            <div class="col-12">
                <div class="card-default">
                    <form action="{{ route('driver.store') }}" method="POST" class="form d-flex flex-column gap-3 w-100"
                        ...
                        <div class="row g-3">
                            ...
                            <div class="col-md-6">
                                <div class="input-group d-flex flex-column">
                                    ...
                                    <input type="text"
                                        ...
                                        placeholder="Enter your identity card number.." autocomplete="off" required>
                            ...
                            <div class="col-md-6">
                                <div class="input-group d-flex flex-column">
                                    ...
                                    <input type="text"
                                        ...
                                        placeholder="Enter your drivers license number.." autocomplete="off" required>
                            ...
                            <div class="col-12">
                                <div class="input-group d-flex flex-column">
                                    ...
                                    <select class="input w-100 @error('status') input-invalid @enderror" name="status"
                                        id="status" required>
                                        <option value="">Choose status driver</option>
                            ...
                            <div class="col-12">
                                <div class="button-group d-flex gap-2">
                                    <button type="submit" class="button-primary-small">Add New Driver</button>
                                    <a href="{{ route('driver.index') }}" class="button-reverse">Cancel Add</a>
                                </div>
                            </div>
                        </div>
                    </form>
