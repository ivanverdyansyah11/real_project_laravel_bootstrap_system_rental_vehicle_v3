                            ...
                            <div class="col-md-6">
                                <div class="input-group d-flex flex-column">
                                    ...
                                    <input type="text" class="input w-100" name="fullname" id="fullname"
                                        autocomplete="off" readonly value="{{ $user->customer->fullname }}">
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="input-group d-flex flex-column">
                            ...
                            <div class="col-md-6">
                                <div class="input-group d-flex flex-column">
                                    ...
                                    <input type="text" class="input w-100" name="phone_number" id="phone_number"
                                        autocomplete="off" readonly value="{{ $user->customer->phone_number }}">
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="input-group d-flex flex-column">
                                    ...
                                    <input type="text" class="input w-100" name="nik" id="nik"
                                        autocomplete="off" readonly value="{{ $user->customer->nik }}">
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="input-group d-flex flex-column">
                                    ...
                                    <input type="text" class="input w-100" name="identity_card_number"
                                        ...
                                        value="{{ $user->customer->identity_card_number }}">
                                </div>
                            </div>
                            <div class="col-12">
                                <div class="input-group d-flex flex-column">
                                    <label for="family_card_number">Family Card Number</label>
                                    <input type="text" class="input w-100" name="family_card_number"
                                        id="family_card_number" autocomplete="off" readonly
                                        value="{{ $user->customer->family_card_number }}">
                                </div>
                            </div>
                            <div class="col-12">
                                <div class="input-group d-flex flex-column">
                                    <label for="address">Address</label>
                                    <textarea class="input w-100" name="address" id="address" autocomplete="off" rows="4" readonly>{{ $user->customer->address }}</textarea>
                                </div>
                            </div>
                            <div class="col-12">
                                <div class="button-group d-flex gap-2">
                                    <a href="{{ route('customer.index') }}" class="button-reverse">Back to Customer
                                        Page</a>
                                </div>
                            </div>
                        </div>
