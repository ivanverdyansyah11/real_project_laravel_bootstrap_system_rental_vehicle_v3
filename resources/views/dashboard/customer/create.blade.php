        ...
        <div class="row">
            ...
            <div class="col-12">
                <div class="card-default">
                    <form action="{{ route('customer.store') }}" method="POST" class="form d-flex flex-column gap-3 w-100"
                        ...
                        <div class="row g-3">
                            ...
                            <div class="col-md-6">
                                <div class="input-group d-flex flex-column">
                                    ...
                                    <input type="text"
                                        ...
                                        placeholder="Enter your family card number.." autocomplete="off" required>
                            ...
                            <div class="col-12">
                                <div class="button-group d-flex gap-2">
                                    <button type="submit" class="button-primary-small">Add New Customer</button>
                                    <a href="{{ route('customer.index') }}" class="button-reverse">Cancel Add</a>
                                </div>
                            </div>
                        </div>
                    </form>
