                        ...
                        <div class="row g-3">
                            ...
                            <div class="col-md-6">
                                <div class="input-group d-flex flex-column">
                                    ...
                                    <input type="text" class="input w-100 @error('fullname') input-invalid @enderror"
                                        name="fullname" id="fullname" value="{{ $user->admin->fullname }}"
                            ...
                            <div class="col-md-6">
                                <div class="input-group d-flex flex-column">
                                    ...
                                    <input type="text" class="input w-100 @error('phone_number') input-invalid @enderror"
                                        name="phone_number" id="phone_number" value="{{ $user->admin->phone_number }}"
                                        autocomplete="off" required>
                                    @error('phone_number')
                                        <p class="text-invalid">{{ $message }}</p>
                                    @enderror
                            ...
                            <div class="col-12">
                                <div class="input-group d-flex flex-column">
                                    ...
                                    <input type="text" class="input w-100 @error('nik') input-invalid @enderror"
                                        name="nik" id="nik" value="{{ $user->admin->nik }}" autocomplete="off"
                                        required>
                                    @error('nik')
                                        <p class="text-invalid">{{ $message }}</p>
                                    @enderror
                            ...
                            <div class="col-12">
                                <div class="input-group d-flex flex-column">
                                    ...
                                    <textarea class="input w-100 @error('address') input-invalid @enderror" name="address" id="address" autocomplete="off"
                                        rows="4" required>{{ $user->admin->address }}</textarea>
                                    @error('address')
                                        <p class="text-invalid">{{ $message }}</p>
                                    @enderror
                                </div>
                            ...
                            <div class="col-12">
                                <div class="button-group d-flex gap-2">
                                    ...
                                    <a href="{{ route('admin.index') }}" class="button-reverse">Cancel Edit</a>
                                </div>
                            </div>
                        </div>
                    </form>
